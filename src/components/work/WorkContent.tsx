...
export const CATEGORIES = [
  { name: "All", href: "/work" },
  { name: "UI/UX Design", href: "/work/ui-ux" },
  { name: "Front End Design", href: "/work/frontend" },
  { name: "Brand Identity", href: "/work/brand-identity" },
  { name: "Motion Graphics", href: "/work/motion-graphics" }
];

// Projects are now fetched dynamically from Sanity
            ...
            {filteredProjects.map((project) => (
              ...
              >
                <Link href={`/work/${project.slug}`} className="group block relative h-[400px] rounded-[var(--radius-container)] overflow-hidden">
                  ...
                  {/* Glassmorphic Gradient Mask (Creates the fading blur) */}
                  <div className="absolute inset-x-0 bottom-0 h-[70%] blur-gradient-overlay z-10" />
                  
                  {/* Glassmorphic Tint (Semi-transparent black to maintain readability without hiding the blur) */}
